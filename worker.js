  ...
  async fetch(request, env) {
    ...
    if (url.pathname.endsWith('/diagram')) {
      ...
      try {
        ...
        const diagramPrompt = `Analyse this AI answer and extract a diagram. First decide the type - use \"flowchart\" if the answer describes STEPS, a PROCESS, a SEQUENCE, or HOW TO DO something. Use \"mindmap\" for CONCEPTS, OPTIONS, FEATURES, or WHAT something is.\n\nReturn ONLY valid JSON, no markdown:\n\nFor flowchart: {\"type\":\"flowchart\",\"steps\":[{\"id\":\"s1\",\"label\":\"short action 4 words max\",\"detail\":\"1-2 sentences\",\"code\":\"optional path or snippet\"}]}\nRules: 3-7 steps in order. Label = imperative verb phrase. Steps must be sequential.\n\nFor mindmap: {\"type\":\"mindmap\",\"center\":\"topic max 4 words\",\"nodes\":[{\"id\":\"n1\",\"label\":\"max 3 words\",\"detail\":\"1-2 sentences\",\"code\":\"optional\"}],\"edges\":[{\"from\":\"center\",\"to\":\"n1\"}]}\nRules: 3-6 nodes. Labels max 3 words.\n\nReturn ONLY the JSON object.ommons Worker — v3
 * Scoring engine: TF-IDF weighted, phrase-boosted, stopword-filtered
 * Secrets: QP_API_KEY, GITHUB_TOKEN (Cloudflare env vars)
 */
const GITHUB_RAW  = "https://raw.githubusercontent.com/adityagopalkrishnan-dotcom/solutions/main";
